...
const Profile = () => {
  ...
  return (
    <div className='flex'>
      {active ?
        <div className={`left flex flex-col h-screen w-10/12 md:w-1/3 text-white bg-neutral-800 px-3`}>
          <div className='bg-zinc-100 p-3 text-black flex flex-col items-center justify-center rounded-md'>
